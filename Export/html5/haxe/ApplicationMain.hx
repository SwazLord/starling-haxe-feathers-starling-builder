...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("StarlingProject", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("StarlingProject", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["packageName"] = "com.sample.starlingproject";
