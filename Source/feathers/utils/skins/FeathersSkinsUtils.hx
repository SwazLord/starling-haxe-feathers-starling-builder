...
class FeathersSkinsUtils {
	 ...
	 */
	public static function resetFluidChildDimensionsForMeasurement(child:DisplayObject, parentExplicitWidth:Float, parentExplicitHeight:Float,
			parentExplicitMinWidth:Float, parentExplicitMinHeight:Float, parentExplicitMaxWidth:Float, parentExplicitMaxHeight:Float,
			childExplicitWidth:Float, childExplicitHeight:Float, childExplicitMinWidth:Float, childExplicitMinHeight:Float, childExplicitMaxWidth:Float,
			childExplicitMaxHeight:Float):Void {
		if (child == null) {
			return;
		}
