...
class LayoutViewPort extends LayoutGroup implements IViewPort {
	...
	public function set_minVisibleWidth(value:Float):Float {
		...
		if (valueIsNaN && this._explicitMinVisibleWidth != this._explicitMinVisibleWidth) // isNaN
		{
			return value;
		}
	...
	public function set_minVisibleHeight(value:Float):Float {
		...
		var valueIsNaN:Bool = value != value; // isNaN
		if (valueIsNaN && this._explicitMinVisibleHeight != this._explicitMinVisibleHeight) // isNaN
		{
			return value;
		}
