...
class Scroller extends FeathersControl implements IFocusDisplayObject {
	...
	public function get_horizontalScrollBarPosition():String {
		return this._horizontalScrollBarPosition;
	}

	public function set_horizontalScrollBarPosition(value:String):String {
	...
	public function set_horizontalPageIndex(value:Int):Int {
	...
	public function get_horizontalPageCount():Int {
		if (this._maxHorizontalPageIndex == MathUtils.INT_MAX || this._minHorizontalPageIndex == MathUtils.INT_MIN) {
	...
	public function set_verticalPageIndex(value:Int):Int {
		if (!this._snapToPages) {
	...
	public function get_verticalPageCount():Int {
		if (this._maxVerticalPageIndex == MathUtils.INT_MAX || this._minVerticalPageIndex == MathUtils.INT_MIN) {
			return MathUtils.INT_MAX;
		}
	...
	public function get_minimumPageThrowVelocity():Float {
		return _minimumPageThrowVelocity;
	}
	...
	public function get_hideScrollBarAnimationEase():String {
		return this._hideScrollBarAnimationEase;
	}

	public function set_hideScrollBarAnimationEase(value:String):String {
	...
	private var _throwEase:Dynamic = defaultThrowEase;
	...
	public function get_isTopPullViewActive():Bool {
		return this._isTopPullViewActive;
	}

	public function set_isTopPullViewActive(value:Bool):Bool {
	...
	public function get_topPullView():DisplayObject {
		return this._topPullView;
	}

	public function set_topPullView(value:DisplayObject):DisplayObject {
		if (this._topPullView != null) {
	...
	public function get_topPullViewDisplayMode():String {
		return this._topPullViewDisplayMode;
	}

	public function set_topPullViewDisplayMode(value:String):String {
	...
	public function get_topPullViewRatio():Float {
		return this._topPullViewRatio;
	}

	public function set_topPullViewRatio(value:Float):Float {
	...
	public function get_isRightPullViewActive():Bool {
		return this._isRightPullViewActive;
	}

	public function set_isRightPullViewActive(value:Bool):Bool {
	...
	public function get_rightPullView():DisplayObject {
		return this._rightPullView;
	}

	public function set_rightPullView(value:DisplayObject):DisplayObject {
		if (this._rightPullView != null) {
	...
	public function get_rightPullViewDisplayMode():String {
		return this._rightPullViewDisplayMode;
	}

	public function set_rightPullViewDisplayMode(value:String):String {
	...
	public function get_rightPullViewRatio():Float {
		return this._rightPullViewRatio;
	}

	public function set_rightPullViewRatio(value:Float):Float {
	...
	public function get_isBottomPullViewActive():Bool {
		return this._isBottomPullViewActive;
	}

	public function set_isBottomPullViewActive(value:Bool):Bool {
	...
	public function get_bottomPullView():DisplayObject {
		return this._bottomPullView;
	}

	public function set_bottomPullView(value:DisplayObject):DisplayObject {
		if (this._bottomPullView != null) {
	...
	public function get_bottomPullViewDisplayMode():String {
		return this._bottomPullViewDisplayMode;
	}

	public function set_bottomPullViewDisplayMode(value:String):String {
	...
	public function get_bottomPullViewRatio():Float {
		return this._bottomPullViewRatio;
	}

	public function set_bottomPullViewRatio(value:Float):Float {
	...
	public function get_isLeftPullViewActive():Bool {
		return this._isLeftPullViewActive;
	}

	public function set_isLeftPullViewActive(value:Bool):Bool {
	...
	public function get_leftPullView():DisplayObject {
		return this._leftPullView;
	}

	public function set_leftPullView(value:DisplayObject):DisplayObject {
		if (this._leftPullView != null) {
	...
	public function get_leftPullViewRatio():Float {
		return this._leftPullViewRatio;
	}

	public function set_leftPullViewRatio(value:Float):Float {
	...
	public function get_leftPullViewDisplayMode():String {
		return this._leftPullViewDisplayMode;
	}

	public function set_leftPullViewDisplayMode(value:String):String {
	...
	public function scrollToPosition(horizontalScrollPosition:Float, verticalScrollPosition:Float, animationDuration:Null<Float> = null):Void {
		...
		#end
		{
			if (this._useFixedThrowDuration) {
				...
				var point:Point = Pool.getPoint(horizontalScrollPosition - this._horizontalScrollPosition,
					verticalScrollPosition - this._verticalScrollPosition);
	...
	private function autoSizeIfNeeded():Bool {
		...
		if (needsWidth) {
			...
			if (this.currentBackgroundSkin != null && this.currentBackgroundSkin.width > newWidth) {
		...
		if (needsHeight) {
			...
			if (this.currentBackgroundSkin != null && this.currentBackgroundSkin.height > newHeight) {
	...
	private function createScrollBars():Void {
		...
		if (this._scrollBarDisplayMode != ScrollBarDisplayMode.NONE
			...
			&& this._horizontalScrollBarFactory != null) {
		...
		if (this._scrollBarDisplayMode != ScrollBarDisplayMode.NONE
			...
			&& this._verticalScrollBarFactory != null) {
	...
	private function calculateViewPortOffsetsForFixedHorizontalScrollBar(forceScrollBars:Bool = false, useActualBounds:Bool = false):Void {
		if (this.horizontalScrollBar != null && (this._measureViewPort || useActualBounds)) {
			...
			if (!useActualBounds && !forceScrollBars && scrollerWidth != scrollerWidth) // isNaN
			{
	...
	private function calculateViewPortOffsetsForFixedVerticalScrollBar(forceScrollBars:Bool = false, useActualBounds:Bool = false):Void {
		if (this.verticalScrollBar != null && (this._measureViewPort || useActualBounds)) {
			...
			if (!useActualBounds && !forceScrollBars && scrollerHeight != scrollerHeight) // isNaN
			{
			...
			if (this._topPullTween == null) {
				...
				if (finalRatio > 0) {
					if (this._topPullViewDisplayMode == PullViewDisplayMode.FIXED) {
						...
						this._topPullView.y = this._topViewPortOffset + this._topPullView.pivotY * this._topPullView.scaleY + (finalRatio * pullViewSize)
							- pullViewSize;
					}
			...
			if (this._rightPullTween == null) {
				...
				if (finalRatio > 0) {
					if (this._rightPullViewDisplayMode == PullViewDisplayMode.FIXED) {
						this._rightPullView.x = this._rightPullView.pivotX * this._rightPullView.scaleX + this.actualWidth - this._rightViewPortOffset
							- pullViewSize;
					} else {
						this._rightPullView.x = this._rightPullView.pivotX * this._rightPullView.scaleX + this.actualWidth - this._rightViewPortOffset
							- (finalRatio * pullViewSize);
					}
	...
	private function refreshTopPullViewMask():Void {
		...
		var maskHeight:Float = pullViewHeight
			+ ((this._topPullView.y - this._topPullView.pivotY * this._topPullView.scaleY - this._paddingTop) / this._topPullView.scaleY);
		if (maskHeight < 0) {
			maskHeight = 0;
	...
	private function refreshRightPullViewMask():Void {
		...
		var maskWidth:Float = this.actualWidth
			- this._rightViewPortOffset
			- ((this._rightPullView.x - this._rightPullView.pivotX / this._rightPullView.scaleX) / this._rightPullView.scaleX);
		if (maskWidth < 0) {
			maskWidth = 0;
	...
	private function refreshBottomPullViewMask():Void {
		...
		var maskHeight:Float = this.actualHeight
			- this._bottomViewPortOffset
			- ((this._bottomPullView.y - this._bottomPullView.pivotY / this._bottomPullView.scaleY) / this._bottomPullView.scaleY);
		if (maskHeight < 0) {
			maskHeight = 0;
		} else if (maskHeight > pullViewHeight) {
			maskHeight = pullViewHeight;
	...
	private function refreshLeftPullViewMask():Void {
		...
		var maskWidth:Float = pullViewWidth
			+ ((this._leftPullView.x - this._leftPullView.pivotX * this._leftPullView.scaleX - this._paddingLeft) / this._leftPullView.scaleX);
		if (maskWidth < 0) {
			maskWidth = 0;
		} else if (maskWidth > pullViewWidth) {
			maskWidth = pullViewWidth;
	...
	public function get_numRawChildrenInternal():Int {
	...
	private function throwTo(targetHorizontalScrollPosition:Null<Float> = null, targetVerticalScrollPosition:Null<Float> = null, duration:Float = 0.5):Void {
		if (targetHorizontalScrollPosition == null)
			targetHorizontalScrollPosition = Math.NaN;
		if (targetVerticalScrollPosition == null)
			targetVerticalScrollPosition = Math.NaN;
	...
	private function restoreVerticalPullViews():Void {
		...
		if (this._topPullView != null && this._topPullViewRatio > 0) {
			...
			if (this._topPullViewDisplayMode == PullViewDisplayMode.DRAG) {
				yPosition = this._topViewPortOffset + this._topPullView.pivotY * this._topPullView.scaleY;
				if (!this._isTopPullViewActive) {
				...
				if (this._topPullView.y != yPosition) {
					...
					Starling.current.juggler.add(this._topPullTween);
				}
			} else {
		...
		if (this._bottomPullView != null && this._bottomPullViewRatio > 0) {
			...
			if (this._bottomPullViewDisplayMode == PullViewDisplayMode.DRAG) {
				yPosition = this.actualHeight - this._bottomViewPortOffset + this._bottomPullView.pivotY * this._bottomPullView.scaleY;
				if (this._isBottomPullViewActive) {
				...
				if (this._bottomPullView.y != yPosition) {
					...
					Starling.current.juggler.add(this._bottomPullTween);
				}
			} else {
	...
	private function restoreHorizontalPullViews():Void {
		...
		if (this._leftPullView != null && this._leftPullViewRatio > 0) {
			...
			if (this._leftPullViewDisplayMode == PullViewDisplayMode.DRAG) {
				xPosition = this._leftViewPortOffset + this._leftPullView.pivotX * this._leftPullView.scaleX;
				if (!this._isLeftPullViewActive) {
				...
				if (this._leftPullView.x != xPosition) {
					...
					Starling.current.juggler.add(this._leftPullTween);
				}
			} else {
		...
		if (this._rightPullView != null && this._rightPullViewRatio > 0) {
			...
			if (this._rightPullViewDisplayMode == PullViewDisplayMode.DRAG) {
				xPosition = this.actualWidth - this._rightViewPortOffset + this._rightPullView.pivotX * this._rightPullView.scaleX;
				if (this._isRightPullViewActive) {
				...
				if (this._rightPullView.x != xPosition) {
					...
					Starling.current.juggler.add(this._rightPullTween);
				}
			} else {
	...
	private function completeScroll():Void {
		if (!this._isScrolling
			...
			|| this._isDraggingVertically
			|| this._horizontalScrollBarIsScrolling
			|| this._verticalScrollBarIsScrolling) {
			return;
		}
	...
	private function handlePendingPullView():Void {
		...
		if (this._isTopPullViewPending) {
			...
			if (this._isTopPullViewActive) {
				...
				if (this._topPullViewDisplayMode == PullViewDisplayMode.DRAG) {
					targetY = this._topViewPortOffset + this._topPullView.pivotY * this._topPullView.scaleY;
					if (this.isCreated) {
		...
		if (this._isRightPullViewPending) {
			...
			if (this._isRightPullViewActive) {
				...
				if (this._rightPullViewDisplayMode == PullViewDisplayMode.DRAG) {
					targetX = this.actualWidth - this._rightViewPortOffset + this._rightPullView.pivotX * this._rightPullView.scaleX
		...
		if (this._isLeftPullViewPending) {
			...
			if (this._isLeftPullViewActive) {
				...
				if (this._leftPullViewDisplayMode == PullViewDisplayMode.DRAG) {
					targetX = this._leftViewPortOffset + this._leftPullView.pivotX * this._leftPullView.scaleX;
					if (this.isCreated) {
		...
		if (!this._isDraggingHorizontally
			&& (this._horizontalScrollPolicy == ScrollPolicy.ON
				|| (this._horizontalScrollPolicy == ScrollPolicy.AUTO
					&& this._minHorizontalScrollPosition != this._maxHorizontalScrollPosition)
				|| (this._leftPullView != null
					&& (this._currentTouchX > this._startTouchX || this._horizontalScrollPosition < this._minHorizontalScrollPosition))
				|| (this._rightPullView != null
					&& (this._currentTouchX < this._startTouchX || this._horizontalScrollPosition > this._minHorizontalScrollPosition)))
			&& (((horizontalInchesMoved <= -this._minimumDragDistance)
		...
		if (!this._isDraggingVertically
			&& (this._verticalScrollPolicy == ScrollPolicy.ON
				...
				|| (this._topPullView != null
					&& (this._currentTouchY > this._startTouchY || this._verticalScrollPosition < this._minVerticalScrollPosition))
				|| (this._bottomPullView != null
					&& (this._currentTouchY < this._startTouchY || this._verticalScrollPosition > this._minVerticalScrollPosition)))
			&& (((verticalInchesMoved <= -this._minimumDragDistance)
				&& (this._hasElasticEdges
					|| this._verticalScrollPosition < this._maxVerticalScrollPosition
					|| this._bottomPullView != null))
				|| ((verticalInchesMoved >= this._minimumDragDistance)
	...
	private function scroller_touchHandler(event:TouchEvent):Void {
		...
		if (touchX < this._leftViewPortOffset
			|| touchY < this._topViewPortOffset
	...
	private function nativeStage_mouseWheelHandler(event:MouseEvent):Void {
		...
		if ((this._verticalMouseWheelScrollDirection == Direction.VERTICAL
			&& (this._maxVerticalScrollPosition == this._minVerticalScrollPosition || this._verticalScrollPolicy == ScrollPolicy.OFF))
			|| (this._verticalMouseWheelScrollDirection == Direction.HORIZONTAL
				&& (this._maxHorizontalScrollPosition == this._minHorizontalScrollPosition
					|| this._horizontalScrollPolicy == ScrollPolicy.OFF))) {
			return;
		}
		...
		var point:Point = Pool.getPoint((event.stageX - starlingViewPort.x) * scaleFactor, (event.stageY - starlingViewPort.y) * scaleFactor);
		...
		if (!isContained) {
			...
			Pool.putPoint(point);
			if (localMouseX < this._leftViewPortOffset
				|| localMouseY < this._topViewPortOffset
	...
	override function focusInHandler(event:Event):Void {
		...
		var priority:Int = -FeathersDisplayUtil.getDisplayObjectDepthFromStage(this);
	...
	private function nativeStage_keyDownHandler(event:KeyboardEvent):Void {
		...
		if (this._horizontalScrollPosition != newHorizontalScrollPosition && this._horizontalScrollPolicy != ScrollPolicy.OFF) {
			event.preventDefault();
			this.horizontalScrollPosition = newHorizontalScrollPosition;
		}
		if (this._verticalScrollPosition != newVerticalScrollPosition && this._verticalScrollPolicy != ScrollPolicy.OFF) {
			event.preventDefault();
