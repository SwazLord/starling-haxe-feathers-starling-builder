...
class LayoutGroup extends FeathersControl {
	 ...
	 */
	private inline static var INVALIDATION_FLAG_CLIPPING:String = "clipping";
		...
		if (this.currentBackgroundSkin != oldBackgroundSkin) {
			...
			if (this.currentBackgroundSkin != null) {
				...
				if (this.currentBackgroundSkin is IMeasureDisplayObject) {
					var measureSkin:IMeasureDisplayObject = cast(this.currentBackgroundSkin, IMeasureDisplayObject);
